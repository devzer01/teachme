...
class weatherxxxx {
    ...
    {
        $idealogy = new Ideology('happiness', 0xF0F);
        $idea1 = new Idea('ability to maintain balanced mood through the day');
        $concepts = ['ability', 'maintain', 'balance', 'mood', 'through', 'the', 'day'];
        $ability = new Concept();
        $ability->nodes(['being' => ['be', 'ing'], 'able' => ['habiltas', 'means', 'skills']]);
        $idea2 = new Idea('preserving energy by controlling unwanted thoughts that would lead to bad emotion');
